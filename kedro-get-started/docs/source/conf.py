...
# kedro_get_started documentation build
...
from kedro_get_started import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_get_started"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_get_starteddoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_get_started.tex",
        "kedro_get_started Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_get_started",
        "Project kedro_get_started codebase.",
        "Data-Science",
    )
]
